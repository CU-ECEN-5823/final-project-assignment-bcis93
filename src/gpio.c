...
#define DISPLAY_GPIO_PORT (gpioPortF)
#define DISPLAY_GPIO_ENABLE_PIN (14)
#define DISPLAY_EXTCOMIN_PIN (18)
...
void gpioSetDisplayExtcomin(bool high)
{
	if (high)
	{
		GPIO_PinOutSet(DISPLAY_GPIO_PORT, DISPLAY_EXTCOMIN_PIN);
	}
	else
	{
		GPIO_PinOutClear(DISPLAY_GPIO_PORT, DISPLAY_EXTCOMIN_PIN);
	}
}
